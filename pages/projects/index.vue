    ...
    <div class="bg-card rounded-lg shadow-sm border border-border-color overflow-hidden p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div
          ...
          :key="project.id"
          class="bg-card border border-border-color rounded-lg p-5 flex flex-col justify-between hover:border-primary hover:scale-[1.005] transition-all duration-200 hover:shadow-lg"
        >
          <div>
